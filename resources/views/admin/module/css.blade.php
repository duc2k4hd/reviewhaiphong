...
<link rel="stylesheet" href="{{ asset('admins/assets/vendor/fonts/boxicons.css?v=' . time()) }}" />

<!-- Core CSS -->
<link rel="stylesheet" href="{{ asset('admins/assets/vendor/css/core.css?v=' . time()) }}"
    class="template-customizer-core-css" />
<link rel="stylesheet" href="{{ asset('admins/assets/vendor/css/theme-default.css?v=' . time()) }}"
