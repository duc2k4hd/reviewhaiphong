...
@section('title', 'Tạo bài viết mới - Staff')
...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <!--  -->
            <div class="card">
                <h5 class="card-header">Thêm bài viết mới - Staff</h5>
                <div class="container">
                    @if (session('success'))
                    ...
                    <div class="alert alert-info mb-4">
                        ...
                        <strong>Lưu ý:</strong> Bài viết của Staff sẽ được tạo ở trạng thái "Chờ duyệt" và cần Admin phê duyệt trước khi xuất bản.
                    </div>

                    <form method="POST" action="{{ route('admin.staff.posts.new.handle') }}" enctype="multipart/form-data"
